<h2>  Power of Three</h2><hr><div style="user-select: auto;"><p style="user-select: auto;">Given an integer <code style="user-select: auto;">n</code>, return <em style="user-select: auto;"><code style="user-select: auto;">true</code> if it is a power of three. Otherwise, return <code style="user-select: auto;">false</code></em>.</p>
...
<pre style="user-select: auto;"><strong style="user-select: auto;">Input:</strong> n = 9
<strong style="user-select: auto;">Output:</strong> true
</pre>
