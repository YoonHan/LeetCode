<h2>  Single Number</h2><hr><div style="user-select: auto;"><p style="user-select: auto;">Given a <strong style="user-select: auto;">non-empty</strong>&nbsp;array of integers <code style="user-select: auto;">nums</code>, every element appears <em style="user-select: auto;">twice</em> except for one. Find that single one.</p>
