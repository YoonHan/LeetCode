<h2>  First Unique Character in a String</h2><hr><div style="user-select: auto;"><p style="user-select: auto;">Given a string <code style="user-select: auto;">s</code>, <em style="user-select: auto;">find the first non-repeating character in it and return its index</em>. If it does not exist, return <code style="user-select: auto;">-1</code>.</p>
